...
const UpdateItem = () => {
    ...
    // console.log(name, category, price, recipe, image, _id)
    const { name, category, price, recipe, image: previousImage, _id } = useLoaderData();
                ...
                <div className="max-w-4xl h-[80%] bg-white mx-auto space  p-5 md:p-8 lg:p-12 shadow-xl rounded-md">
                    <div>
                        <form onSubmit={handleSubmit(onSubmit)}>
                            ...
                            <div className="mb-6">
                                <label className="block mb-2 text-sm font-medium dark:text-yellow-600">
                                    Previous Image
                                </label>
                                <input type="text"
                                name="previousImage"
                            ...
                            <div className="mb-6">
                                <label className="block mb-2 text-sm font-medium dark:text-yellow-500">Update Image</label>
                                <input
                                    {...register("image")}
                                    type="file"
                                    onChange={(e) => {
