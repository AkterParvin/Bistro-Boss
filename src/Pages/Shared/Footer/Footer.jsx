...
const Footer = () => {
    return (
        <div>
            <footer className="px-4 divide-y bg-slate-800 text-white dark:bg-gray-800 dark:text-gray-100">
                <div className="max-w-screen-xl mx-auto flex flex-col justify-between py-10  space-y-8 lg:flex-row lg:space-y-0">
